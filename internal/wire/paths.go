...
// Well-known URL paths. Every endpoint is versioned under /wreath/v0 from
...
//
//	GET /.well-known/wreath/v0/manifest      → the signed manifest envelope
//	GET /.well-known/wreath/v0/blob/<sha256> → a file body, content-addressed
//
// Agents relay every member's bundle under a per-member prefix, and add
// health + notify:
//
//	GET  /.well-known/wreath/v0/members/<id>/manifest
//	GET  /.well-known/wreath/v0/members/<id>/blob/<sha256>
//	GET  /.well-known/wreath/v0/health
//	POST /.well-known/wreath/v0/notify       {"member_id": "..."}
const (
	WellKnownPrefix = "/.well-known/wreath/v0"
